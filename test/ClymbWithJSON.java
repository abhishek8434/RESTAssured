...
public class ClymbWithJSON {
    ...
    public Object[][] getUserData() {
        ...
        String jsonFile = "Enter your file path here";  // Adjust path if needed

        try {
            ObjectMapper objectMapper = new ObjectMapper();
            List<Map<String, String>> userList = objectMapper.readValue(new File(jsonFile), new TypeReference<List<Map<String, String>>>() {});
            
            for (Map<String, String> user : userList) {
                users.add(new Object[]{user.get("username"), user.get("password")});
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
